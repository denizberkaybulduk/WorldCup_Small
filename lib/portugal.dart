...
class PorGamePlay extends StatefulWidget {
  const PorGamePlay({Key? key}) : super(key: key);

  @override
  State<PorGamePlay> createState() => _PorGamePlayState();
}

class _PorGamePlayState extends State<PorGamePlay> {
              ...
              TextButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => displayPlayersPOR()));
                  },
                  child: Text(
                    "Players",
                  ...
                  TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>formationPortugal()));
                  },
                  child: Text(
                    "Formation",
                    style: TextStyle(color: Colors.white, fontSize: 25),
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                    style: ButtonStyle(
                        backgroundColor:
                            MaterialStateProperty.all(Color.fromARGB(255, 25, 117, 109))),
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
